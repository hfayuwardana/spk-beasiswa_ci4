...
/* CATATAN: 
	URL home mahasiswa: localhost:8080

	URL home admin: localhost:8080/authenticate
	username: admin
	password: pass4admin
*/
...
$routes->get('/mhs/verifikasi', 'MahasiswaController::cariDataPribadi');
...
// $routes->put('/admin/updateAkun/(:segment)', 'AdminController::updateAkun/$1'); //update & delete langsung memanggil controller
...
// $routes->put('/mahasiswa/updateMahasiswa/(:segment)', 'AdminController::updateMahasiswa/$1'); //update & delete langsung memanggil controller
...
// $routes->put('/beasiswa/updateBeasiswa/(:segment)', 'AdminController::updateBeasiswa/$1'); //update & delete langsung memanggil controller
...
// $routes->put('/kriteria/updateKriteria/(:segment)/(:segment)', 'AdminController::updateKriteria/$1/$2'); //update & delete langsung memanggil controller
...
// $routes->put('/bobot/updateBobot/(:segment)/(:segment)/(:segment)', 'AdminController::updateBobot/$1/$2/$3'); //update & delete langsung memanggil controller
